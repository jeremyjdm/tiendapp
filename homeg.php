...
<div class="container">
    ...
    <h1>Bienvenido,  Gerente. </h1> <!-- Reemplaza [Nombre del Usuario] con la variable adecuada -->
...
<div class="container">
    ...
    <div class="product">
        ...
        <h2>Clientes</h2>
        <form action="clientes.php" method="POST"> <!-- Asegúrate de que 'clientes.php' existe -->
            <button class="buy-button">Entrar</button>
        </form>
    </div>
    ...
    <div class="product">
        ...
        <div class="features"></div>
        <form action="pagos.php" method="POST"> <!-- Asegúrate de que 'metodos_pago.php' existe -->
            <button class="buy-button">Entrar</button>
        </form>
    </div>
</div>
